...
public class HoldFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Call<List<RetroUsers>> call = service.getPDetails(completedhold);
        ...
        call.enqueue(new Callback<List<RetroUsers>>() {
            ...
            public void onFailure(Call<List<RetroUsers>> call, Throwable throwable) {
                showImage();
                Toast.makeText(getActivity(), "Unable to load Dump Projects please try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
